 ...
 |_| \_|\__,_|_|_|)";
    ...
    while (true) {
        ...
        if (command == "quit") {
            ...
            system("~/Documents/ArcOS/ArcNull/cpp/idek");
        } else if (command == "rpg") {
            system("~/Documents/ArcOS/ArcNull/cpp/rpg");
	    ...
	    system("shutdown 0");
          ...
          system("~/Documents/ArcOS/ArcNull/cpp/ssh_connect");
        }
        else if (command == "sl") {
          system("sl");
        }
        else if (command == "apps") {
          system("~/Documents/ArcOS/ArcNull/cpp/apps");
        }
        else if (command == "vnc") {
          system("~/Documents/ArcOS/ArcNull/cpp/vnc_connect");
        }
        else if (command == "arcc") {
            system("~/Documents/ArcOS/ArcNull/cpp/Arcc");
        }
        ...
        system("~/Documents/ArcOS/ArcNull/c/nmap_check");
    }
    else if (command == "cp") {
        string x;
        string y;
        ...
        system("~/Documents/ArcOS/ArcNull/c/ip_check");
    }
